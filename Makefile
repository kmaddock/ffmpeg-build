...
# =============================================================================
# Download macro: curl with retry, fail if empty
# =============================================================================
...
$(PACKAGES)/zlib-1.3.2.tar.gz: | dirs
	$(call download_file,https://github.com/madler/zlib/releases/download/v1.3.2/zlib-1.3.2.tar.gz)
...
$(PACKAGES)/giflib-5.2.2.tar.gz: | dirs
	$(call download_file,https://sf-eu-introserv-1.dl.sourceforge.net/project/giflib/giflib-5.x/giflib-5.2.2.tar.gz)
...
$(PACKAGES)/gettext-1.0.tar.gz: | dirs
	$(call download_file,https://ftpmirror.gnu.org/gettext/gettext-1.0.tar.gz)
...
$(PACKAGES)/openssl-3.6.1.tar.gz: | dirs
	$(call download_file,https://github.com/openssl/openssl/archive/refs/tags/openssl-3.6.1.tar.gz)
...
$(PACKAGES)/gmp-6.3.0.tar.xz: | dirs
	$(call download_file,https://ftpmirror.gnu.org/gnu/gmp/gmp-6.3.0.tar.xz)
...
$(PACKAGES)/nettle-3.10.2.tar.gz: | dirs
	$(call download_file,https://ftpmirror.gnu.org/gnu/nettle/nettle-3.10.2.tar.gz)
...
$(PACKAGES)/dav1d-1.5.3.tar.gz: | dirs
	$(call download_file,https://code.videolan.org/videolan/dav1d/-/archive/1.5.3/dav1d-1.5.3.tar.gz)
...
$(PACKAGES)/svtav1-4.0.1.tar.gz: | dirs
	$(call download_file,https://gitlab.com/AOMediaCodec/SVT-AV1/-/archive/v4.0.1/SVT-AV1-v4.0.1.tar.gz)
...
$(PACKAGES)/rav1e-0.8.1.tar.gz: | dirs
	$(call download_file,https://github.com/xiph/rav1e/archive/refs/tags/v0.8.1.tar.gz)
...
$(PACKAGES)/libvpx-1.16.0.tar.gz: | dirs
	$(call download_file,https://github.com/webmproject/libvpx/archive/refs/tags/v1.16.0.tar.gz)
...
$(PACKAGES)/zimg-3.0.6.tar.gz: | dirs
	$(call download_file,https://github.com/sekrit-twc/zimg/archive/refs/tags/release-3.0.6.tar.gz)
...
$(PACKAGES)/x264-0480cb05.tar.gz: | dirs
	$(call download_file,https://code.videolan.org/videolan/x264/-/archive/0480cb05/x264-0480cb05.tar.gz)
...
$(PACKAGES)/x265-8be7dbf.tar.gz: | dirs
	$(call download_file,https://bitbucket.org/multicoreware/x265_git/get/8be7dbf8159ddfceea4115675a6d48e1611b8baa.tar.gz)
...
$(PACKAGES)/xvidcore-1.3.7.tar.gz: | dirs
	$(call download_file,https://downloads.xvid.com/downloads/xvidcore-1.3.7.tar.gz)
...
$(PACKAGES)/vid.stab-1.1.1.tar.gz: | dirs
	$(call download_file,https://github.com/georgmartius/vid.stab/archive/v1.1.1.tar.gz)
...
$(PACKAGES)/fdk-aac-2.0.3.tar.gz: | dirs
	$(call download_file,https://sourceforge.net/projects/opencore-amr/files/fdk-aac/fdk-aac-2.0.3.tar.gz/download?use_mirror=gigenet)
...
$(PACKAGES)/srt-1.5.4.tar.gz: | dirs
	$(call download_file,https://github.com/Haivision/srt/archive/v1.5.4.tar.gz)
...
$(PACKAGES)/zvbi-0.2.44.tar.gz: | dirs
	$(call download_file,https://github.com/zapping-vbi/zvbi/archive/refs/tags/v0.2.44.tar.gz)
...
$(PACKAGES)/opencore-amr-0.1.6.tar.gz: | dirs
	$(call download_file,https://deac-ams.dl.sourceforge.net/project/opencore-amr/opencore-amr/opencore-amr-0.1.6.tar.gz)
...
$(PACKAGES)/lame-3.100.tar.gz: | dirs
	$(call download_file,https://sourceforge.net/projects/lame/files/lame/3.100/lame-3.100.tar.gz/download?use_mirror=gigenet)
...
$(PACKAGES)/opus-1.6.1.tar.gz: | dirs
	$(call download_file,https://downloads.xiph.org/releases/opus/opus-1.6.1.tar.gz)
...
$(PACKAGES)/libogg-1.3.6.tar.xz: | dirs
	$(call download_file,https://ftp.osuosl.org/pub/xiph/releases/ogg/libogg-1.3.6.tar.xz)
...
$(PACKAGES)/libvorbis-1.3.7.tar.gz: | dirs
	$(call download_file,https://ftp.osuosl.org/pub/xiph/releases/vorbis/libvorbis-1.3.7.tar.gz)
...
$(PACKAGES)/libtheora-1.2.0.tar.gz: | dirs
	$(call download_file,https://ftp.osuosl.org/pub/xiph/releases/theora/libtheora-1.2.0.tar.gz)
...
$(PACKAGES)/soxr-0.1.3.tar.xz: | dirs
	$(call download_file,https://sourceforge.net/projects/soxr/files/soxr-0.1.3-Source.tar.xz/download?use_mirror=gigenet)
...
$(PACKAGES)/lv2-1.18.10.tar.xz: | dirs
	$(call download_file,https://lv2plug.in/spec/lv2-1.18.10.tar.xz)
...
$(PACKAGES)/serd-v0.32.8.tar.gz: | dirs
	$(call download_file,https://gitlab.com/drobilla/serd/-/archive/v0.32.8/serd-v0.32.8.tar.gz)
...
$(PACKAGES)/pcre-8.45.tar.gz: | dirs
	$(call download_file,https://altushost-swe.dl.sourceforge.net/project/pcre/pcre/8.45/pcre-8.45.tar.gz)
...
$(PACKAGES)/zix-v0.8.0.tar.gz: | dirs
	$(call download_file,https://gitlab.com/drobilla/zix/-/archive/v0.8.0/zix-v0.8.0.tar.gz)
...
$(PACKAGES)/sord-v0.16.22.tar.gz: | dirs
	$(call download_file,https://gitlab.com/drobilla/sord/-/archive/v0.16.22/sord-v0.16.22.tar.gz)
...
$(PACKAGES)/sratom-v0.6.22.tar.gz: | dirs
	$(call download_file,https://gitlab.com/lv2/sratom/-/archive/v0.6.22/sratom-v0.6.22.tar.gz)
...
$(PACKAGES)/lilv-v0.26.4.tar.gz: | dirs
	$(call download_file,https://gitlab.com/lv2/lilv/-/archive/v0.26.4/lilv-v0.26.4.tar.gz)
...
$(PACKAGES)/tiff-4.7.1.tar.xz: | dirs
	$(call download_file,https://download.osgeo.org/libtiff/tiff-4.7.1.tar.xz)
...
$(PACKAGES)/libpng-1.6.55.tar.gz: | dirs
	$(call download_file,https://sourceforge.net/projects/libpng/files/libpng16/1.6.55/libpng-1.6.55.tar.gz)
...
$(PACKAGES)/lcms2-2.18.tar.gz: | dirs
	$(call download_file,https://github.com/mm2/Little-CMS/releases/download/lcms2.18/lcms2-2.18.tar.gz)
...
$(PACKAGES)/libjxl-0.11.2.tar.gz: | dirs
	$(call download_file,https://github.com/libjxl/libjxl/archive/refs/tags/v0.11.2.tar.gz)
...
$(PACKAGES)/libwebp-1.6.0.tar.gz: | dirs
	$(call download_file,https://storage.googleapis.com/downloads.webmproject.org/releases/webp/libwebp-1.6.0.tar.gz)
...
$(PACKAGES)/SDL2-2.30.12.tar.gz: | dirs
	$(call download_file,https://github.com/libsdl-org/SDL/releases/download/release-2.30.12/SDL2-2.30.12.tar.gz)
...
$(PACKAGES)/freetype-2.14.2.tar.xz: | dirs
	$(call download_file,https://downloads.sourceforge.net/freetype/freetype-2.14.2.tar.xz)
...
$(PACKAGES)/vapoursynth-R73.tar.gz: | dirs
	$(call download_file,https://github.com/vapoursynth/vapoursynth/archive/R73.tar.gz)
...
$(PACKAGES)/zeromq-4.3.5.tar.gz: | dirs
	$(call download_file,https://github.com/zeromq/libzmq/releases/download/v4.3.5/zeromq-4.3.5.tar.gz)
...
$(PACKAGES)/Vulkan-Headers-1.4.341.0.tar.gz: | dirs
	$(call download_file,https://github.com/KhronosGroup/Vulkan-Headers/archive/refs/tags/vulkan-sdk-1.4.341.0.tar.gz)
...
$(PACKAGES)/glslang-16.2.0.tar.gz: | dirs
	$(call download_file,https://github.com/KhronosGroup/glslang/archive/refs/tags/16.2.0.tar.gz)
...
$(PACKAGES)/nv-codec-headers-13.0.19.0.tar.gz: | dirs
	$(call download_file,https://github.com/FFmpeg/nv-codec-headers/releases/download/n13.0.19.0/nv-codec-headers-13.0.19.0.tar.gz)
...
$(PACKAGES)/AMF-1.5.0.tar.gz: | dirs
	$(call download_file,https://github.com/GPUOpen-LibrariesAndSDKs/AMF/archive/refs/tags/v1.5.0.tar.gz)
...
$(PACKAGES)/OpenCL-Headers-2025.07.22.tar.gz: | dirs
	$(call download_file,https://github.com/KhronosGroup/OpenCL-Headers/archive/refs/tags/v2025.07.22.tar.gz)
...
$(PACKAGES)/OpenCL-ICD-Loader-2025.07.22.tar.gz: | dirs
	$(call download_file,https://github.com/KhronosGroup/OpenCL-ICD-Loader/archive/refs/tags/v2025.07.22.tar.gz)
